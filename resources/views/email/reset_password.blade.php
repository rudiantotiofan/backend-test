            ...
            <tbody>
                            ...
                            <tbody>
                                <tr bgcolor="#ff5a00">
                                    <td style="padding:0 30px" colspan="2">
                                        <h2 style="color:#fff;font-family: 'Yanone Kaffeesatz', sans-serif;text-transform:uppercase;letter-spacing:1px">DIGITAL PLUS</h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background:url({{ url('assets/frontend/img/bg_arrow.png') }}) no-repeat 30px 0">
                                            <tbody>
                                                <tr>
                                                    <td width="30px">&nbsp;</td>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="padding:40px 0 10px ">
                                                                        <font style="font-family: 'Nunito', sans-serif;color:#000000; font-size:16px;">Hi {{$email}}, Thanks for join us!</font>
                                                                ...
                                                                <tr>
                                                                    <td style="padding:20px 0 30px">
                                                                        ...
                                                                        @if(!empty($activation_code))
                                                                            To reset password your account, <a href="{{ $url }}" style="word-wrap:break-word;color:#376edc">click this link</a>
                                                                            <br /><br />
                                                                        @endif
                                                                        </div>
                                                                    </td>
                ...
                <tr style="background:#e8e8e8;">
                    <td align="center" colspan="2" style="padding:10px;">
                        <font style="font-family: 'Nunito', sans-serif;color:#949494; font-size:12px;">&copy;Copyright 2018 POS SYSTEM | All right reserved</font>
                    </td>
                </tr>
            </tbody>
        </table>
